    ...
    <nav>
      <div class="navbar">
        <span class="logo-container">
          <a href="/">
            <img src="/logo.png" alt="Logo" id="logo" decoding="async" loading="lazy" width="15%" height="auto" class="thumbimage">
            <h1>ColorMaze</h1>
          </a>
        </span>
        <span class="menu">
              ...
              <ul>
                ...
                <li class="dropdown">
                  ...
                  <div class="dropdown-content2">
                    <nuxt-link to="../test_folder/Test">Color Palette Checker</nuxt-link> 
                  </div>
                </li>
                <li class="dropdown">
